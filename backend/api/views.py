...
from .serializers import UserSerializer, NoteSerializer  #from the serializers.py
from rest_framework.permissions import IsAuthenticated, AllowAny
from .models import Note
# Create your views here.

# make the class based view that will alow us to implement creating a new user or kind like a reg form and others
